...
import CenteredImage from '../../../src/components/HomepageFeatures/CenteredImage.js'
...
<div style={{ textAlign: 'center' }}>
  <img src={require('../../../static/bd/3-registro.png').default} alt="registro" width="200" height="200" />
</div>
